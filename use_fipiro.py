...
sspace_mat_sym = u.make_state_space_sym(num_s_state_space,
...
ssp = s.SignalStateSpace(n_x=num_x_state_space,
...
fi = f.FullInfoModel(ssp, all_names,
...
fun1n, fun2n = fi.make_numpy_fns_of_d1d2xw(dfi_unev, dse_unev)
dfi_n, dse_n = fi.get_dgdxw12_evaluated_at_ss(mod='numpy')
# psi_x, psi_w, psi_q =  fi.get_first_order_approx_coeff_fi()
# # psi_second_order = fi.get_second_order_coeff_fi_from_fo(psi_x, psi_w, psi_q, dfi_n, dse_n)
# # psi_x_x, psi_x_w, psi_x_q, psi_w_w, psi_w_q, psi_q_q = psi_second_order 

# # psi_second_order2 = fi.get_second_order_coeff_fi()
# # psi_x_x2, psi_x_w2, psi_x_q2, psi_w_w2, psi_w_q2, psi_q_q2 = psi_second_order2 
