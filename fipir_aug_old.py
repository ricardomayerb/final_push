...
#         
        ...
        du_dx =  utility_sym_mat.jacobian([self.xvar_t_sym])   
        du_dx_nopar =  [u.subs(self.par_to_values_dict) for u in list(du_dx)]
        du_dx_at_ss = [u.subs(self.normal_and_0_to_ss).subs(self.ss_solutions_dict) for u in du_dx_nopar]
        du_dx_at_ss = self.matrix2numpyfloat(sympy.Matrix(du_dx_at_ss))
        ...
        du_dx_dx_at_ss = du_dx_dx_nopar.subs(self.normal_and_0_to_ss).subs(self.ss_solutions_dict)
        ...
        du_dx_dq_at_ss = du_dx_dq_nopar.subs(self.normal_and_0_to_ss).subs(self.ss_solutions_dict)
